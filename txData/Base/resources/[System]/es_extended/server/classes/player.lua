function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords)
	...
	function self.hasItem(item, metadata)
		local Item = exports['qs-core']:GetItem(self.source, item)
	...
	function self.showNotification(title, msg, time, type)
		self.triggerEvent('esx:showNotification', title, msg, time, type)
	end
