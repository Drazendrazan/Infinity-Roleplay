...
function ESX.ShowNotification(title, message, time, type)
    if not time or not message or not type then
        exports["okokNotify"]:Alert("", title, 2000, 'info')
    else
...
AddEventHandler('esx:showNotification', function(title, msg, time, type)
    ESX.ShowNotification(title, msg, time, type)
end)
