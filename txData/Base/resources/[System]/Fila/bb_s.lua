...
function ProccessQueue(steamID, discordID, d, _source)
	...
	PerformHttpRequest("https://discordapp.com/api/guilds/" .. Config.DiscordServerID .. "/members/"..string.sub(discordID, 9), function(err, text, headers) 
		if text ~= nil then
			...
			memberRoleNames = memberRoleNames ~= "" and memberRoleNames or "Membro"
...
function GetMessage()
    ...
    for k, v in pairs(playersInfo) do
        ...
        elseif counter == 10 then
        	msg = msg .. 'E mais ' .. #playersInfo - counter .. ' jogadores.\n'
        	counter = counter + 1
        end
    end

    cardd.body[2].text = msg
    cardd.body[3].text = "Tamanho da fila: " .. tostring(#playersInfo) .. " | Jogaodres: " .. #GetPlayers() .. "/" .. Config.maxServerSlots
