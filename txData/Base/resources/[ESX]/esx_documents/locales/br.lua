    ...
    },
    {
      ...
      elements = {
        ...
        { label = "OUTRAS INFORMAÇÕES", type = "textarea",
          value = "DECLARO QUE O CIDADÃO AFORMENCIADO COMPLETOU UM PAGAMENTO COM O MONTANTE DE DÉBITO APROVISIONADO",
          can_be_emtpy = false, can_be_edited = false },
      }
    }
  },
  ["police"] = {
    {
      ...
      elements = {
        ...
        { label = "INFORMAÇÃO", type = "textarea",
          value = "O CIDADÃO AFORMAMENCIADO FOI CONCEDIDO A PERMISSÃO ILIMITADA DE ESTACIONAMENTO EM CADA ZONA DA CIDADE E ESTÁ VÁLIDO ATÉ A DATA DE VENCIMENTO PREVISTA.",
          can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "INFORMAÇÃO", type = "textarea",
          value = "O CIDADÃO PERMANENTE É PERMITIDO E CONCEDE UMA AUTORIZAÇÃO DE ARMA QUE SERÁ VÁLIDA ATÉ A DATA DE VALIDADE PREVISTA.",
          can_be_emtpy = false },
      }
    },
    {
      headerTitle = "REGISTO CRIMINAL CIDADÃO LIMPO",
      headerSubtitle = "Registo oficial limpo, de propósito geral, de antecedentes criminais.",
      elements = {
        { label = "CIDADÃO NOME", type = "input", value = "", can_be_emtpy = false },
        { label = "CIDADÃO SOBNOME", type = "input", value = "", can_be_emtpy = false },
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "REGISTO", type = "textarea",
          value = "A POLÍCIA DECLARA QUE O CIDADÃO AFORO-NACIONADO TEM UMA GRAVAÇÃO CRIMINAL CLARA. ESTE RESULTADO É GERADO A PARTIR DE DADOS SUBMETIDOS NO SISTEMA DE GRADUAÇÃO PENAL ATRAVÉS DA DATA DO SINAL DO DOCUMENTO.",
          can_be_emtpy = false, can_be_edited = false },
      }
    }
  },
  ["ambulance"] = {
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "NOTAS MÉDICAS", type = "textarea",
          value = "O CIDADÃO ASSEGURADO CONSIDERADO FOI TESTADO POR UM OFICIAL DE SAÚDE E DETERMINADO SAUDÁVEL, SEM DETECÇÃO DE CONDIÇÕES DE LONGO PRAZO. ESTE RELATÓRIO É VÁLIDO ATÉ A DATA DE VALIDADE PREVISTA.",
          can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "NOTAS MÉDICAS", type = "textarea",
          value = "O CIDADÃO ASSEGURADO CONSIDERADO FOI TESTADO POR UM OFICIAL DE SAÚDE E DETERMINADO MENTALMENTE SAUDÁVEL PELAS NORMAS DE PSICOLOGIA APROVADAS MAIS BAIXAS. ESTE RELATÓRIO É VÁLIDO ATÉ A DATA DE VALIDADE PREVISTA.",
          can_be_emtpy = false },
      }
    },
    {
      headerTitle = "RELATÓRIO MÉDICO - TESTE PSICOTÉCNICO PARA OBTENÇÃO DE LICENSA DE CAÇA / PORTE DE ARMA",
      headerSubtitle = "Relatório médico oficial fornecido por um psicólogo/médico.",
      elements = {
        { label = "NOME DO CIVIL", type = "input", value = "", can_be_emtpy = false },
        { label = "APELIDO DO CIVIL", type = "input", value = "", can_be_emtpy = false },
        { label = "NOTAS MÉDICAS", type = "textarea",
          value = "O CIDADÃO ASSEGURADO CONSIDERADO FOI TESTADO POR UM OFICIAL DE SAÚDE E DETERMINADO MENTALMENTE SAUDÁVEL PELAS NORMAS DE PSICOLOGIA APROVADAS MAIS BAIXAS PARA A OBTENÇÃO DA LICENSA DE CAÇA / PORTE DE ARMA.",
          can_be_emtpy = false, can_be_edited = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "NOTAS MÉDICAS", type = "textarea",
          value = "O CIDADÃO ASSEGURADO CONSIDERADO FOI TESTADO POR UM OFICIAL DE CUIDADOS DE SAÚDE E DETERMINADO COM UM OLHOS SAUDÁVEL E PRECISO. ESTE RELATÓRIO É VÁLIDO ATÉ A DATA DE VALIDADE PREVISTA.",
          can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "NOTAS MÉDICAS", type = "textarea",
          value = "THE AFOREMENTIONED INSURED CITIZEN IS GRANTED, AFTER BEING THOROUGHLY EXAMINED BY A HEALTHCARE SPECIALIST, MARIJUANA USAGE PERMIT DUE TO UNDISCLOSED MEDICAL REASONS. THE LEGAL AND PERMITTED AMOUNT A CITIZEN CAN HOLD CAN NOT BE MORE THAN 100grams.",
          can_be_emtpy = false, can_be_edited = false },
      }
    },
  },
  ["lawyer"] = {
    {
      ...
      elements = {
        ...
        { label = "VÁLIDO ATÉ", type = "input", value = "", can_be_empty = false },
        { label = "INFORMAÇÃO", type = "textarea",
          value = "ESTE DOCUMENTO É O PROVA DE REPRESENTAÇÃO LEGAL E COBERTURA DO CIDADÃO ACIMA DESENVOLVIDO. OS SERVIÇOS JURÍDICOS SÃO VÁLIDOS ATÉ A DATA DE VALIDADE PREVISTA.",
          can_be_emtpy = false },
      }
    }
  }
