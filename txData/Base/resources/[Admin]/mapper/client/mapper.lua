...
Mapper.SaveObjects = function(name)
	...
	Citizen.CreateThread(function()
		...
		TriggerServerEvent('mapper:beginSaveObjects', name)

		for i=1, #Mapper.Objects, 1 do

			TriggerServerEvent('mapper:addObjectToSave', name, Mapper.Objects[i])
		...
		TriggerServerEvent('mapper:endSaveObjects', name)
...
Mapper.LoadObjects = function(name)
	...
	TriggerServerEvent('mapper:loadObjects', name)
end
...
RegisterNetEvent('mapper:loadObject')
AddEventHandler('mapper:loadObject', function(object)
	object.frozen = true
	Mapper.AddObject(MapperObject:unSerialize(object))
end)

RegisterNetEvent('mapper:showNotification')
AddEventHandler('mapper:showNotification', function(msg)
