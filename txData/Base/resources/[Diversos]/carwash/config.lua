...
Config.WashPlaces = {
    [1] = {
        ...
        carHeading = 271.01,
        heading = 338.93,
        blip = { enable = true, sprite = 100, display = 4, scale = 0.65, color = 3, name = "Lavagem de Carros" },
        marker = { enable = true, drawDist = 10.0, type = 27, scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 60, g = 255, b = 0, a = 100 } },
    },
}
