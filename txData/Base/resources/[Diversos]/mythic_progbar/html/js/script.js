...
$('document').ready(function() {
    ...
    MythicProgBar.Progress = function(data) {
        ...
        $("#progress-bar").stop().css({"width": 0, "background": "linear-gradient(-90deg, rgba(0, 119, 255, 0.75), rgba(33, 56, 82, 0.50))"}).animate({
          width: '100%'
        }, {
    ...
    MythicProgBar.ProgressCancel = function() {
        ...
        $("#progress-bar").stop().css( {"width": "100%", "background": "linear-gradient(-90deg, rgba(0, 119, 255, 0.75), rgba(33, 56, 82, 0.50))"});
