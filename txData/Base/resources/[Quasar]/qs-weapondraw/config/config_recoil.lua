...
Config.DisableHeadshot = true       ---@param Set true it will remove heatshots (Requiere server restart)
Config.RemovePistolWhipping = true   ---@param Remove weapon whipping (Requiere server restart)
Config.UseCustomWeaponDamages = false ---@param Custom weapon damages true = Yes | false = no. (Requiere server restart)

Config.UseRecoil = true ---@param Enable custom recoil
Config.RightLeftRecoil = true ---@param true = Right Recoil | false = Left Recoil.
Config.RightLeftRecoilRandomiser = true ---@param If this is set to true then the recoil inside a vehicle will not trigger all the time. The value below will set the chance if true.
...
Config.UseVehicleRecoil = true ---@param Enable/Disable recoil inside vehicles.
Config.UseScreenExplosions = true ---@param Adds a small screen explosion, it is affected by how big recoil is.
