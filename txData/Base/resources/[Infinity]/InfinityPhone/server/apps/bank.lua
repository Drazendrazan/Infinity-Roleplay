...
AddEventHandler('InfinityPhone:shared:ComponentsReady', function()
    ...
    Callbacks:RegisterServerCallback('InfinityPhone:server:GetBankTransactions', function(source, data, cb)
    ...
    Callbacks:RegisterServerCallback('InfinityPhone:server:Transfer', function(source, data, cb)
    ...
    Callbacks:RegisterServerCallback('InfinityPhone:server:MazePay', function(source, data, cb)
