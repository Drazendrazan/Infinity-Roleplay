...
Config['VangelicoHeist'] = {
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(-1361.8164, -756.0557, 22.3050),
        peds = {
            {pos = vector3(-1362.3160, -756.0551, 22.3051), heading = 263.8342, ped = 's_m_m_highsec_01'},
            {pos = vector3(-1362.4595, -756.8855, 22.3049), heading = 310.5623, ped = 's_m_m_highsec_02'},
            {pos = vector3(-1362.2643, -755.4647, 22.3051), heading = 224.1794, ped = 's_m_m_fiboffice_02'}
        }
    },
    ['gasMask'] = {
    ...
    ['smashRewards'] = { -- you can add new smash reward items
        ...
        {item = 'anel', price = 100},
        {item = 'diamond_box', price = 200},
        {item = 'gold_chain', price = 150},
...
Config['VangelicoInside'] = {
    ...
    ['painting'] = {
        {
            rewardItem = 'quadro', -- u need add item to database
...
Strings = {
    ['start_heist'] = 'Pressione ~INPUT_CONTEXT~ para iniciar o assalto',
    ...
    ['wait_nextrob'] = 'Tens de esperar antes de assaltar novamente',
    ['minute'] = 'minuto.',
    ['start_stealing'] = 'Pressione ~INPUT_CONTEXT~ para roubar',
    ['cute_right'] = 'Pressione ~INPUT_CONTEXT~ para cortar para a direita',
    ['cute_left'] = 'Pressione ~INPUT_CONTEXT~ para cortar para a esquerda',
    ['cute_down'] = 'Pressione ~INPUT_CONTEXT~ para cortar para baixo',
    ['glass_cut'] = 'Pressione ~INPUT_CONTEXT~ para cortar o vidro',
    ['smash'] = 'Pressione ~INPUT_CONTEXT~ para partir o vidro',
    ['throw_gas_blip'] = 'Throw Gas',
    ['good_shot'] = 'Acertaste!',
    ['need_switchblade'] = 'Precisas de uma faca.',
    ['need_rifle'] = 'Precisas de uma arma.',
    ['need_this'] = 'Precisas de: ',
    ['deliver_to_buyer'] = 'Entrega o roubado ao comprador',
    ['buyer_blip'] = 'Comprador',
    ['need_police'] = 'Não há polícias suficientes.',
