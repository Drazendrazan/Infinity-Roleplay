    ...
    while true do
        ...
        for index, race in pairs(races) do
            ...
            if (time > race.startTime) and (#players == 0) then
                ...
                TriggerClientEvent("InfinityCorridas:removeRace_cl", -1, index)
...
RegisterNetEvent("InfinityCorridas:createRace_sv")
AddEventHandler("InfinityCorridas:createRace_sv", function(amount, startDelay, startCoords, checkpoints, finishTimeout)
    ...
    local index = #races
    TriggerClientEvent("InfinityCorridas:createRace_cl", -1, index, amount, startDelay, startCoords, checkpoints)
end)

-- Server event for canceling a race
RegisterNetEvent("InfinityCorridas:cancelRace_sv")
AddEventHandler("InfinityCorridas:cancelRace_sv", function()
...
RegisterNetEvent("InfinityCorridas:joinRace_sv")
AddEventHandler("InfinityCorridas:joinRace_sv", function(index)
    ...
    if playerMoney >= amount then
        ...
        TriggerClientEvent("InfinityCorridas:joinedRace_cl", source, index)
...
RegisterNetEvent("InfinityCorridas:leaveRace_sv")
AddEventHandler("InfinityCorridas:leaveRace_sv", function(index)
...
RegisterNetEvent("InfinityCorridas:finishedRace_sv")
AddEventHandler("InfinityCorridas:finishedRace_sv", function(index, time)
...
RegisterNetEvent("InfinityCorridas:saveRace_sv")
AddEventHandler("InfinityCorridas:saveRace_sv", function(name, checkpoints)
...
RegisterNetEvent("InfinityCorridas:deleteRace_sv")
AddEventHandler("InfinityCorridas:deleteRace_sv", function(name)
...
RegisterNetEvent("InfinityCorridas:listRaces_sv")
AddEventHandler("InfinityCorridas:listRaces_sv", function()
...
RegisterNetEvent("InfinityCorridas:loadRace_sv")
AddEventHandler("InfinityCorridas:loadRace_sv", function(name)
    ...
    if race ~= nil then
        ...
        TriggerClientEvent("InfinityCorridas:loadRace_cl", source, race)
