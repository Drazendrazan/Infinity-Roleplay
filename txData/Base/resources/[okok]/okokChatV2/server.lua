local Webhook = 'https://discord.com/api/webhooks/1039610787536318484/mEJBmltN9zcjzVr0xCYGdbcMjXTV3e3-NKV9Ub04y4wSvcY8YrrRdcFkh1rYppE81UEc' -- PUT YOUR WEBHOOK LINK HERE
...
function getName(identifier)
	...
	MySQL.Async.fetchAll('SELECT * FROM users WHERE identifier = @identifier', {
		...
		if db_name[1] ~= nil and db_name[1].firstname ~= nil and db_name[1].lastname ~= nil then
