			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div class="ldata-txt">A carregar...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
		...
		case 'transactions_page':
			...
			for (var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					...
					icon = '<td class="align-middle"><span class="transactions-action"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle fw500">
					Em <span class="transactions-name">${name}</span>
			...
			$('#page_info').html(`
				<div class="row mb-3">
					...
					<div class="col col-md-3 pr05 pl05">
						<div class="card stats-title">
							<div class="card-body text-center">
								<h6 class="card-title">ENVIADO</h6>
	...
	if (event.data.isUpdate && selectedWindow == "bankmenu" || !event.data.isUpdate) {
					...
					<div class="col-md-12">
						<div class="card last-t-card">
							<div class="card-header card-o-header text-center">
								<span class="card-o-title">Últimas Transações<span class="badge bg-primary viewall-badge" id="view_all_transactions"><i class="fas fa-eye"></i> VER MAIS</span></span>
							</div>
		...
		for (var i = 0; i < num; i++) {
			...
			if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
				...
				icon = '<td class="align-middle"><span class="lastT-action"><i class="bi bi-download"></i></span></td>';
				data = `<td class="align-middle lastT-name-div">
							Em <span class="lastT-name">${name}</span>
							<div class="mtm3125">Depositado</div>
						</td>`;
				amount = `<td class="align-middle fw500 lastT-received"><span class="floatr">+ €${db.value.toLocaleString()}</span></td>`;
				// Withdrawn
			...
			<div class="col-md-7 chart-main">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card last-t-card">
							<div class="card-header card-o-header text-center">
								<span class="card-o-title">Últimas Transações<span class="badge bg-primary viewall-badge" id="view_all_transactions_society"><i class="fas fa-eye"></i> VER MAIS</span></span>
							</div>
							<div class="card-body" id="last-t-body">
								<table id="lastTransactionsTable">
									<tbody id="lastTransactionsData">
				...
				<div class="col-md-12">
					<div class="card ccard-card">
						...
						<div class="card-body ccard-body">
							...
							<hr>
							<p class="card-text text-center ccard-fs" style="margin-bottom: 1.1rem;""><span class="fff">Saldo:</span> €<span id="playerBankMoney"></span></p>
							<p class="card-text text-center ccard-fs"><span class="fff">IBAN:</span> <span id="playerIBAN"></span></p>
						</div>
					</div>
					<div class="card text-center h-100 actions-card">
						...
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100 changeiban-card">
									<div class="card-body text-center">
										<span class="fs15 fff">Trocar IBAN</span>
										...
										<button type="button" id="change_iban" class="btn btn-blue" disabled><i class="fas fa-paper-plane"></i> Confirmar</button>
									</div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center settings_info-card">
									<div class="card-body text-center fs1125">
										<span>A troca do IBAN tem um custo de €${event.data.ibanCost}€</span>
										<hr class="fff">
						...
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100 changepin-card">
									<div class="card-body text-center">
										<span class="fs15 fff">Trocar PIN</span>
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center settings_info-card">
									<div class="card-body text-center fs1125">
										<span>A troca do PIN tem um custo de €${event.data.pinCost}</span>
										<hr class="fff">
										<span>O máximo de números são ${event.data.pinCharNum}</span>
										<hr class="fff">
	...
	setTimeout(function () {
		$('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div class="ldata-txt">A sair...</div>
			</div>
		`);
		$("#menu").fadeIn();
